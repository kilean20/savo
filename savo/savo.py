...
class savo:
    ...
    def train_model(self,
        ...
        self.model = GaussianProcess(train_x,train_y,train_yvar,self.obj_func,obj_func_noise=self.obj_func_noise)
    ...
    def _get_SG_step(self,
        ...
        dydx = self._get_dydx(n_grad_ave).detach().numpy()
    ...
    def step(self,
        ...
        if lr > 0:
            self.train_model()
            dxSG = self._get_SG_step(optimizer=optimizer)
